 ...
 */
final class Version20231116092112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE directory (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, directory_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, INDEX IDX_467844DA7E3C61F9 (owner_id), INDEX IDX_467844DA2C94069F (directory_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
